...
history = th.train(model=model, train_loader=train_loader, test_loader=test_loader, optimizer=optimizer, loss_fun=loss_fun, epochs=epochs, checkpoint_dir="ModelCheckpoints/TruncatedDCT", encoding="truncdct", debug=True)
