...
# python trainspiketrain.py > "$LOG_DIR/SpikeTrain/spiketrain_${ENC1DATESTAMP}_${ENC1TIMESTAMP}.log" 2> "$LOG_DIR/SpikeTrain/spiketrain_${ENC1DATESTAMP}_${ENC1TIMESTAMP}.err"
